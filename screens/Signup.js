...
const Signup = ({navigation}) => {
  ...
  return (
    <View style={[styles.container,{width}]}>
      ...
      <Image source={require('../assets/images/s1.png')} style={[styles.login_img1, { resizeMode: 'contain'}]}/>
      <Image source={require('../assets/images/s2.png')} style={[styles.login_img2, { resizeMode: 'contain'}]}/>
        ...
        <View style={[styles.logform,{width}]}>
          ...
          <View style={styles.form_fields}>
            ...
            <View style={styles.field_con}>
              ...
              <TextInput textContentType='emailAddress' keyboardType="email-address" style={styles.field} />
            </View>
            <TouchableOpacity  
