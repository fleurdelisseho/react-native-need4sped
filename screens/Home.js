  ...
  return (
    <View style={[styles.container]}>
      ...
      <ScrollView showVerticalScrollIndicator={false}  style={{width}}>
        <View style={[styles.top_circle,{width}]}>
        </View>
        <View style={[styles.top_circle2,{width}]}>
        </View>
        ...
        <View style={styles.home_header}>
            ...
            <TouchableOpacity 
              ...
              onPress={ () =>{soundClick(); navigation.navigate('Account'); }}
        ...
        <View style={styles.body}>
          ...
          <View style={styles.dashboard_halfs}>
            <TouchableOpacity
                 onPress={ () =>{soundClick(); navigation.navigate('ABC'); }}
                activeOpacity={.7}
              ...
              >
                <View style={styles.label_con}><Text style={styles.top_label}>ABC</Text></View>
                <Text style={styles.dashboard_title}>Letter{'\n'}Tracing</Text>
                <Image source={require('../assets/images/abc.png')} style={[styles.dashboard_img, { resizeMode: 'contain'}]}/>
              </LinearGradient>
            ...
            <TouchableOpacity
                activeOpacity={.7}
                style={styles.btn_dashboard}
                onPress={ () =>{soundClick(); navigation.navigate('Numbers'); }}
              >
              ...
              >
                <View style={styles.label_con}><Text style={styles.top_label}>123</Text></View>
                <Text style={[styles.dashboard_title,styles.dashboard_title_sm]}>Counting{'\n'}Numbers</Text>
                <Image source={require('../assets/images/counting.png')} style={[styles.dashboard_img, { resizeMode: 'contain'}]}/>
              </LinearGradient>
